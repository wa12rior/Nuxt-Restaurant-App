<template>
    <main class="container">
        <section class="image" :style="`background: url('/${currentItem.img}'); center center no-repeat;`"></section>
        <section class="details">
            ...
            Checkout out more <nuxt-link to="/restaurants">restaurants</nuxt-link>
            </AppToast>
